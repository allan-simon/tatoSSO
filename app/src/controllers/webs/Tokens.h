...
#ifndef TATO_SSOCONTROLLERS_WEBS_TOKENS_H
#define TATO_SSOCONTROLLERS_WEBS_TOKENS_H
...
namespace webs {
/**
 * @class Tokens module to centralize action related to token grated to user on services
 * @since 31 March 2014
 */
class Tokens : public ::controllers::webs::Controller {
    public:
        /**
         * @brief Constructor
         * @since 31 March 2014
         */
        Tokens(cppcms::service &serv);
    ...
    private:
         ...
         */
        tatosso::models::Tokens *tokensModel;
